        ...
        <div className="container-custom">
          ...
          <div className="bg-card rounded-xl p-6 md:p-10 animate-on-load opacity-0">
            ...
            <p className="text-muted-foreground mb-8 max-w-3xl">
              Our debut exhibition at Redeemer's University brought together undergraduate artists from three institutions: Redeemer's University, the University of Lagos, and Obafemi Awolowo University, Ife, for a single, cross-campus conversation about form, identity, and craft. The activities included an art exhibition, face painting, children's art corner, interactive mural, art panel sessions and performances.
            </p>
